...
namespace LeapLibrary
{
    ...
    public class LeapComponet : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected void HandPlane()
        {
            ...
            {
                handBaseline.X = handSpace.X;
                handBaselineCounter.X = baselineFidelity.X;
            }

            handSpace.Y = hand.PalmPosition.y;
            /*
            handBaselineCounter.Y--;            
            if (handBaselineCounter.Y <= 0)
            {
                handBaseline.Y = handSpace.Y;
                handBaselineCounter.Y = baselineFidelity.Y;
            }
            */


            handBaselineCounter.Z--;
            handSpace.Z = hand.PalmPosition.z;
            if (handBaselineCounter.Z <= 0)
            {
                handBaseline.Z = handSpace.Z;
